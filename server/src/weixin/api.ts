...
import { redactBody, redactUrl } from "./util.js";
import type {
  BaseInfo,
  GetUploadUrlReq,
  GetUploadUrlResp,
...
const ILINK_APP_CLIENT_VERSION: number = buildClientVersion(PACKAGE_VERSION);
